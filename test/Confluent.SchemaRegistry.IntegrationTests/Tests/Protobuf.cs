...
namespace Confluent.SchemaRegistry.IntegrationTests
{
    public static partial class Tests
    {
        ...
        public static void Protobuf(Config config)
        {
            ...
            var latestSchema2 = sr.GetSchemaAsync(subject, latestSchema.Version).Result; // should come back as text.
            ...
            Assert.Null(schemaAsSerialized.References);
            ...
            Assert.Null(schemaAsText2.References);
            ...
            Assert.ThrowsAny<Exception>(() => {
                sr.RegisterSchemaAsync(sr.ConstructKeySubjectName(topicName+"3"), new Schema(avroSchema, SchemaType.Protobuf)).Wait();
            });
        }
    }
}
