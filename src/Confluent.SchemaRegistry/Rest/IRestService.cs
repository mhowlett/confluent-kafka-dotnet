...
namespace Confluent.SchemaRegistry
{
    ...
    {
        Task<RegisteredSchema> CheckIfSchemaRegisteredAsync(string subject, Schema schema, bool ignoreDeletedSchemas);
        ...
        Task<RegisteredSchema> GetSchemaAsync(int id, string format = null);
