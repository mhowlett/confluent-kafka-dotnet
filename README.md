...
Reference the [Confluent.Kafka NuGet package](https://www.nuget.org/packages/Confluent.Kafka/) (version 0.9.4.0).

To install confluent-kafka-dotnet from within Visual Studio, run the following command in the Package Manager Console:

```
Install-Package Confluent.Kafka -Pre -Version 0.9.4.0
```

To reference in a dotnet core project, add `"Confluent.Kafka": "0.9.4.0"` to the dependencies section of the project.json file.
